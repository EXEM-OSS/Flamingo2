...
import org.opencloudengine.flamingo2.mapreduce.util.filter.BypassPathFilter;
...
public class HdfsUtils {
    ...
    public static String getFilename(InputSplit inputSplit) {
        String filename = org.opencloudengine.flamingo2.mapreduce.util.FileUtils.getFilename(inputSplit.toString());
