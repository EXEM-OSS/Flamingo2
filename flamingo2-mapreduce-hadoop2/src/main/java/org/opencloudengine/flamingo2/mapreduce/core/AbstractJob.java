...
import org.opencloudengine.flamingo2.mapreduce.util.CommandLineUtil;
import org.opencloudengine.flamingo2.mapreduce.util.DefaultOptionCreator;
...
public abstract class AbstractJob extends Configured implements Tool {
     ...
     * SLF4J API
     */
    public static final Logger log = LoggerFactory.getLogger(AbstractJob.class);
