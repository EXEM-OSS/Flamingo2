...
/**
 * 타입이 Polyline 인 SHP 파일을 CSV 파일로 바꿔주는 Mapper
 *
 * @author Haneul, Kim
 * @since 2.1.0
 */
public class PolylineMapper extends Mapper<LongWritable, PolylineWritable, LongWritable, MapWritable> {
    ...
    @Override
    protected void map(LongWritable key, PolylineWritable value, Context context) throws IOException, InterruptedException {
        // write value
        Point2D[] coordinates2D = value.polyline.getCoordinates2D();
