 ...
 */
Ext.define('Flamingo2.view.realtime.spark.streaming.chart.SparkStreamingSumChart', {
    extend: 'Ext.chart.CartesianChart',
    alias: 'widget.sparkStreamingSumChart',

    bind: {
        store: '{sparkStreamingSumChartStore}'
    },
    ...
    listeners: {
        afterrender: 'onAfterRenderSparkStreamingSumChart'
    },
    tbar: [
        {
            xtype: 'tbtext',
        ...
        },
        {
            ...
            listeners: {
                select: function (field, value, eOpts) {
                    ...
                    var endDateFields = query('sparkStreamingSumChart #sparkEndDate');
        ...
        },
        {
            ...
            listeners: {
                select: function (field, value, eOpts) {
                    var startDateFields = query('sparkStreamingSumChart #sparkStartDate');
        ...
        },
        {
            ...
            labelWidth: 50,
            listeners: {
                click: 'onSparkStreamingSumChartFindClick'
            }
        },
        {
            xtype: 'button',
            ...
            labelWidth: 50,
            listeners: {
                click: 'onSparkStreamingSumChartResetClick'
            }
        }
    ],
    tools: [
        {
            ...
            handler: 'onSparkStreamingSumChartRefreshClick'
        }
    ]
});