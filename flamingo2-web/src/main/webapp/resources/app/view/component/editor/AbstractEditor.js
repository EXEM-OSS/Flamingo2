 ...
 */
Ext.define('Flamingo2.view.component.editor.AbstractEditor', {
    extend: 'Flamingo2.view.component.editor.EditorPanel',
    alias: 'widget.abstractEditor',

    requires: ['Flamingo2.view.component.editor.EditorMixin'],
