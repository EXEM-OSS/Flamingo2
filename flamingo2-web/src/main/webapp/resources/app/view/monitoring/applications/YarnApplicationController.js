...
Ext.define('Flamingo2.view.monitoring.applications.YarnApplicationController', {
    ...
    onApplicationSumChartAfterRender: function () {
        ...
        setTimeout(function () {
            chart.getStore().getProxy().extraParams.clusterName = ENGINE.id;
            chart.getStore().load();
        }, 10);
    ...
    onTabChanged: function (tabPanel, tab) {
        ...
        if (selection) {
            ...
            switch (activeTabIndex) {
                case 0:
                    var url = CONSTANTS.MONITORING.RM.APP_REPORT;
                    var params = {
                        applicationId: applicationId,
                        clusterName: ENGINE.id
                    };
                    ...
                    invokeGet(url, params,
                        function (response) {
                            ...
                            if (obj.success) {
                                ...
                                } else if (obj.map.yarnApplicationState == 'FINISHED' ||
     ...
     * @returns {*}
     */
    onYarnApplicationKillClick: function (value, metaData, record, row, col, store, gridView) {
