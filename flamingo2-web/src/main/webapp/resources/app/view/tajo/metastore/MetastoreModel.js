 ...
 */
Ext.define('Flamingo2.view.tajo.metastore.MetastoreModel', {
    extend: 'Ext.app.ViewModel',

    alias: 'viewmodel.tajoMetastoreModel',
    ...
    stores: {
        databases: {
            ...
            proxy: {
                type: 'ajax',
                url: CONSTANTS.TAJO.GET_DATABASES,
                extraParams: {
        ...
        columns: {
            ...
            proxy: {
                type: 'ajax',
                url: CONSTANTS.TAJO.GET_COLUMNS,
                reader: {
                    type: 'json',
                    rootProperty: 'list'
                }
        ...
        partitions: {
            ...
            proxy: {
                type: 'ajax',
                url: CONSTANTS.TAJO.GET_PARTITIONS,
                reader: {
                    type: 'json',
                    rootProperty: 'list'
                }
