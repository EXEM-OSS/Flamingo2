 ...
 */
Ext.define('Flamingo2.view.tajo.metastore._DelimiterController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.tajoMetastoreDelimiterController',
    ...
    onOkClick: function () {
        ...
        if (selection.length == 0) {
            Ext.MessageBox.show({
                ...
                message: message.msg('tajo.msg.select_delimiter'),
