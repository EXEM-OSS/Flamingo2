 ...
 */
Ext.define('Flamingo2.view.tajo.metastore._CreateDatabaseController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.tajoCreateDatabaseController',
    ...
    onOKClick: function () {
        ...
        Ext.MessageBox.show({
            ...
            message: message.msg('tajo.msg.create_db'),
    ...
    createDatabase: function (values) {
        ...
        invokePostByMap(
            CONSTANTS.TAJO.CREATE_DATABASE,
            params,
            function (response) {
