Ext.define('Flamingo2.controller.MainAppController', {
    extend: 'Ext.app.Controller',

    requires: [
        'Flamingo2.view.component.WebSocketProxy'
    ],
    ...
    init: function () {
        this.control({
            ...
            'app-main #pnlWest': {
                viewready: this.onSideMenuViewReady
            }
        });
    },
    ...
    onAfterrender: function (panel) {
        ...
        WEBSOCKET = Ext.create('Flamingo2.view.component.WebSocketProxy').connect();
     ...
     **/
    onSideMenuViewReady: function (view) {
        var me = this;
...
/*        if (center.currentPage == namespace) {
            return sideMenu.enable(true);
        }*/

        var menuItemCenterPanel = Ext.create(namespace);

        center.currentPage = namespace;
        center.add(menuItemCenterPanel);

        setTimeout(function () {
            sideMenu.enable(true);
        }, 1200);
    },
