...
public class SqoopExportTask extends InterceptorAbstractTask {
    ...
    private String buildCommand() {
        ...
        try {
            ...
            if (variable.get("fieldDelimiter") != null && !isEmpty(variable.get("fieldDelimiter").toString())) {
                command.add("--fields-terminated-by");
                command.add(variable.getProperty("fieldDelimiter"));
            }

            if (variable.get("lineDelimiter") != null && !isEmpty(variable.get("lineDelimiter").toString())) {
