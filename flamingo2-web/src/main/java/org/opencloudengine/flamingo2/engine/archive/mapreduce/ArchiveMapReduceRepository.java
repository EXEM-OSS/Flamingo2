...
public interface ArchiveMapReduceRepository extends PersistentRepository<MapReduceHistory, Long> {

    String NAMESPACE = ArchiveMapReduceRepository.class.getName();
