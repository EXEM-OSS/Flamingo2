...
public class ShuffleWriteMetrics implements Serializable {
    @SerializedName ("Shuffle Bytes Written") private Long shuffleBytesWritten;
    @SerializedName ("Shuffle Write Time") private Long shuffleWriteTime;
    @SerializedName ("Shuffle Records Written") private Long shuffleRecordsWritten;
