...
public class ProcessInfo {
    ...
    public final class ProcessInfoSnapshot {
        ...
        public long getParentPid() throws ServiceException {
            return (ProcessInfo.this.procState != null) ? ProcessInfo.this.procState.getPpid() : 0L;
        }

        public ProcState getState() throws ServiceException {
            return ProcessInfo.this.procState;
        }

        public ProcExe getExecutable() throws ServiceException {
            return ProcessInfo.this.procExe;
        }

        public ProcTime getTime() throws ServiceException {
            return ProcessInfo.this.procTime;
        }

        public ProcMem getMemory() throws ServiceException {
            return ProcessInfo.this.procMem;
        }

        public ProcCpu getCpu() throws ServiceException {
            return ProcessInfo.this.procCpu;
        }

        public ProcFd getFileDescriptor() throws ServiceException {
            return ProcessInfo.this.procFd;
        }

        public ProcCred getCredentials() throws ServiceException {
            return ProcessInfo.this.procCred;
        }

        public ProcCredName getCredentialsName() throws ServiceException {
         ...
         */
        public String getCurrentWorkingDirectory() throws ServiceException {
            String result = null;
            try {
    ...
    public ProcessInfo(long pid, SigarProxy sigar) throws ServiceException {
        this.pid = pid;
        this.sigar = sigar;
        update(pid);
    }
    ...
    private void update(long pid) throws ServiceException {
...
/*    public AggregateProcessInfo getAggregateProcessTree() {
     ...
     * @since 4.4
     */
    public ProcessInfo getParentProcess() throws ServiceException {
